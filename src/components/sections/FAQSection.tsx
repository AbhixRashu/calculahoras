...
const faqsData: FAQItem[] = [
  ...
  {
    id: 'como-calcular-horas-com-intervalo',
    category: 'calculos',
    categoryLabel: 'Cálculos de Ponto',
    q: 'Como calcular horas trabalhadas com intervalo de almoço?',
    a: 'Para calcular a jornada com intervalo, calcule a diferença entre o horário de saída e o horário de entrada e subtraia o tempo de almoço/descanso. O intervalo intrajornada (Art. 71 da CLT) não conta como tempo trabalhado.',
    example: 'Entrada às 08:00, saída às 17:00 com 1h de almoço: 17:00 − 08:00 = 9h de permanência. Descontando 1h de almoço: 9h − 1h = 8 horas trabalhadas.',
  },
  {
    id: 'sete-horas-trinta-minutos-decimal',
    category: 'calculos',
    categoryLabel: 'Cálculos de Ponto',
    badge: 'Dúvida Frequente',
    q: '7 horas e 30 minutos equivalem a quantas horas em decimal?',
    a: '7 horas e 30 minutos equivalem a exatamente 7,50 horas (ou 7,5 horas). Como uma hora tem 60 minutos, 30 minutos correspondem a meia hora (30 ÷ 60 = 0,50).',
    example: '• 7h 30min = 7,50 horas\n• 7h 45min = 7,75 horas\n• 7h 15min = 7,25 horas\n• 8h 30min = 8,50 horas',
    tip: 'Para calcular salário, multiplique sempre pelo formato decimal (ex: 7,5h × R$ 20/h = R$ 150,00).',
  },
  {
    id: 'dois-periodos-mesmo-dia',
    category: 'calculos',
    categoryLabel: 'Cálculos de Ponto',
    q: 'Como calcular dois períodos de trabalho no mesmo dia?',
    a: 'Calcule o tempo trabalhado no primeiro turno (saída da manhã menos entrada da manhã), calcule o segundo turno (saída da tarde menos volta do almoço) e some os dois períodos.',
    example: '• Manhã: 08:00 às 12:00 = 4 horas\n• Almoço: 12:00 às 13:00 (1h não computada)\n• Tarde: 13:00 às 18:00 = 5 horas\n• Total trabalhado no dia: 4h + 5h = 9 horas (8h normais + 1h extra).',
  },
  {
    id: 'total-de-varios-dias',
    category: 'calculos',
    categoryLabel: 'Cálculos de Ponto',
    q: 'Como calcular o total de horas de vários dias ou da semana?',
    a: 'Some os minutos de cada dia trabalhado e divida o resultado por 60 para obter as horas totais e os minutos restantes. O limite legal padrão é de 44 horas semanais pela CLT.',
    example: '5 dias de 8h48min: (8 × 60 + 48) = 528 min por dia × 5 dias = 2.640 minutos ÷ 60 = exatamente 44 horas semanais.',
    tip: 'Utilize nossa calculadora de "Horas Semanais" para preencher cada dia da semana com intervalos independentes.',
  },
  {
